...
function initMap() {
	...
	function initialize() {
		...
		var mapOptions = {
			zoom: 16,
			center: new google.maps.LatLng(43.890659, -78.882134),
			scrollwheel: false,
		...
		if (width <= 1023) {
			mapOptions = {
				zoom: 16,
				center: new google.maps.LatLng(43.890659, -78.884134),
				scrollwheel: false,
				navigationControl: true,
				mapTypeControl: false,
				scaleControl: true,
		...
		if (width <= 767) {
			mapOptions = {
				zoom: 15,
				center: new google.maps.LatLng(43.888659, -78.886934),
				scrollwheel: false,
				navigationControl: true,
				mapTypeControl: false,
				scaleControl: true,
		...
		if (width <= 479) {
			mapOptions = {
				zoom: 15,
				center: new google.maps.LatLng(43.894159, -78.879934),
				scrollwheel: false,
				navigationControl: true,
				mapTypeControl: false,
				scaleControl: true,
		...
		mapIconImage = (window.devicePixelRatio > 1.5) ? 'images/map-marker.png' : 'images/map-marker.png';
		var myIcon = new google.maps.MarkerImage(mapIconImage, null, null, null, new google.maps.Size(101,160));
		if (width <= 767) {
			mapIconImage = (window.devicePixelRatio > 1.5) ? 'images/map-marker.png' : 'images/map-marker.png';
			var myIcon = new google.maps.MarkerImage(mapIconImage, null, null, null, new google.maps.Size(50,80));
		}
		var beachMarker = new google.maps.Marker({
				position: new google.maps.LatLng(43.889784, -78.880068),
				flat: true,
				map: map,
				icon: myIcon
		});
